...
from src.models.model import OWSNetwork
...
def build_model(args, n_classes):
    ...
    if "decreasing" in args.decoder_channels_mode:
        ...
        print("Notice: argument --channels_decoder is ignored when --decoder_chanels_mode decreasing is set.")
    else:
    ...
    model = OWSNetwork(
        ...
        neck =args.context_module.split("-")[0],
        num_classes=n_classes,
        pretrained_dir=args.pretrained_dir,
        n_decoder_blocks =nr_decoder_blocks,
    ...
    if args.finetune is not None and args.finetune != "None":
