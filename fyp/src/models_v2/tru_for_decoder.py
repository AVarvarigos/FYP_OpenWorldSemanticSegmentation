...
class TruForDecoderHead(nn.Module):
    def __init__(
        self,
        ...
        super(TruForDecoderHead, self).__init__()
    ...
    def forward(self, inputs, return_feats=False):
        ...
        _c4 = F.interpolate(
            _c4, size=c1.size()[2:], mode="bilinear", align_corners=self.align_corners
        )
        ...
        _c3 = F.interpolate(
            _c3, size=c1.size()[2:], mode="bilinear", align_corners=self.align_corners
        )
        ...
        _c2 = F.interpolate(
            _c2, size=c1.size()[2:], mode="bilinear", align_corners=self.align_corners
        )
...
class DecoderHead_2(nn.Module):
    def __init__(self,
        ...
        super(DecoderHead_2, self).__init__()
        self.num_classes = num_classes
        self.dropout_ratio = dropout_ratio
        self.align_corners = align_corners
        ...
        self.linear_c4 = nn.Sequential(
            ...
            nn.ReLU(),
            MLP(input_dim=embedding_dim, embed_dim=embedding_dim),
        )
